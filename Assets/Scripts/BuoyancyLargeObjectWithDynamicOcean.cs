...
public class BuoyancyLargeObjectWithDynamicOcean : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        oceanManager = FindObjectOfType<OceanManager>();    //Use singleton instead for more advanced project
    }
